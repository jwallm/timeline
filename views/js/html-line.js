...
var LINES = (function () {
    ...
    var Line = function (anchor1, anchor2, properties, append_to) {
    ...
    return {
        ...
        createLine: function (anchor1, anchor2, properties, append_to) {
            return new Line(anchor1, anchor2, properties, append_to);
        },
        redraw: function () {
